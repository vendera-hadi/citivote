...
class UsersTableSeeder extends Seeder
{
    ...
    public function run()
    {
      User::insert([
          ...
          ['name' => 'Candidate 3', 'role_id' => 3, 'soeid' => 'cd-3', 'email' => 'candidate3@citivote.com', 'password' => bcrypt('nalarnaluri'), 'image' => 'candidate_3.png', 'nickname' => 'Curious', 'description' => 'Challenge traditional approaches, ask questions and brings outside perspectives' ],
          ['name' => 'Candidate 4', 'role_id' => 3, 'soeid' => 'cd-4', 'email' => 'candidate4@citivote.com', 'password' => bcrypt('nalarnaluri'), 'image' => 'candidate_4.png', 'nickname' => 'Collaborative', 'description' => 'Strong partnering skills, Inclusive of and values diverse perspectives' ],
