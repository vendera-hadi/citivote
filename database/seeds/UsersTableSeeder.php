...
class UsersTableSeeder extends Seeder
{
    ...
    public function run()
    {
      User::insert([
          ...
          ['name' => 'Candidate 3', 'role_id' => 3, 'soeid' => 'cd-3', 'email' => 'candidate3@citivote.com', 'password' => bcrypt('nalarnaluri'), 'image' => 'candidate_3.png', 'nickname' => 'Curious', 'description' => 'Strong partnering skillsm Inclusive of and values diverse perspectives' ],
          ['name' => 'Candidate 4', 'role_id' => 3, 'soeid' => 'cd-4', 'email' => 'candidate4@citivote.com', 'password' => bcrypt('nalarnaluri'), 'image' => 'candidate_4.png', 'nickname' => 'Collaborative', 'description' => 'Challange traditional approaches, ask questions and brings outside perspectives' ],
          ['name' => 'Candidate 5', 'role_id' => 3, 'soeid' => 'cd-5', 'email' => 'candidate5@citivote.com', 'password' => bcrypt('nalarnaluri'), 'image' => 'candidate_5.png', 'nickname' => 'Determined', 'description' => 'Persistent and resilient to setbacks and failures' ],
